...
static void SCB_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
            ...
            else /* Standard or IrDA */
            {
                ...
                if(SCB_1_UART_MODE_STD == subMode)
                {
                    if(0u != (SCB_1_UART_CTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SCB_1_SCLK_PIN_INDEX] = SCB_1_HSIOM_UART_SEL;
                        pinsDm  [SCB_1_SCLK_PIN_INDEX] = SCB_1_PIN_DM_DIG_HIZ;
                    }
                    ...
                    if(0u != (SCB_1_UART_RTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[SCB_1_SS0_PIN_INDEX] = SCB_1_HSIOM_UART_SEL;
                        pinsDm  [SCB_1_SS0_PIN_INDEX] = SCB_1_PIN_DM_STRONG;
    ...
    /* Note: the DR register settings do not effect the pin output if HSIOM is other than GPIO */
        ...
        SCB_1_spi_mosi_i2c_sda_uart_rx_SetDriveMode((uint8) pinsDm[SCB_1_MOSI_SCL_RX_PIN_INDEX]);

    #if (!SCB_1_CY_SCBIP_V1)
        SCB_1_SET_INP_DIS(SCB_1_spi_mosi_i2c_sda_uart_rx_INP_DIS,
                                     SCB_1_spi_mosi_i2c_sda_uart_rx_MASK,
        ...
        SCB_1_spi_mosi_i2c_sda_uart_rx_wake_SetDriveMode((uint8)
                                                               pinsDm[SCB_1_MOSI_SCL_RX_WAKE_PIN_INDEX]);

        SCB_1_SET_INP_DIS(SCB_1_spi_mosi_i2c_sda_uart_rx_wake_INP_DIS,
                                     SCB_1_spi_mosi_i2c_sda_uart_rx_wake_MASK,
        ...
        SCB_1_spi_miso_i2c_scl_uart_tx_SetDriveMode((uint8) pinsDm[SCB_1_MISO_SDA_TX_PIN_INDEX]);

    #if (!SCB_1_CY_SCBIP_V1)
        SCB_1_SET_INP_DIS(SCB_1_spi_miso_i2c_scl_uart_tx_INP_DIS,
                                     SCB_1_spi_miso_i2c_scl_uart_tx_MASK,
        ...
        SCB_1_spi_sclk_uart_cts_SetDriveMode((uint8) pinsDm[SCB_1_SCLK_PIN_INDEX]);

        SCB_1_SET_INP_DIS(SCB_1_spi_sclk_uart_cts_INP_DIS,
                                     SCB_1_spi_sclk_uart_cts_MASK,
        ...
        SCB_1_spi_ss0_uart_rts_SetDriveMode((uint8) pinsDm[SCB_1_SS0_PIN_INDEX]);

        SCB_1_SET_INP_DIS(SCB_1_spi_ss0_uart_rts_INP_DIS,
                                     SCB_1_spi_ss0_uart_rts_MASK,
