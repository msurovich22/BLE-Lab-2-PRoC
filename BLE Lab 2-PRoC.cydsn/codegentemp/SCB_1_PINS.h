...
****************************************/
    ...
    #include "SCB_1_spi_mosi_i2c_sda_uart_rx_wake.h"
#endif /* (SCB_1_MOSI_SCL_RX_WAKE_PIN) */

#if(SCB_1_MOSI_SCL_RX_PIN)
    #include "SCB_1_spi_mosi_i2c_sda_uart_rx.h"
#endif /* (SCB_1_MOSI_SCL_RX_PIN) */

#if(SCB_1_MISO_SDA_TX_PIN)
    #include "SCB_1_spi_miso_i2c_scl_uart_tx.h"
#endif /* (SCB_1_MISO_SDA_TX_PIN_PIN) */

#if(SCB_1_SCLK_PIN)
    #include "SCB_1_spi_sclk_uart_cts.h"
#endif /* (SCB_1_SCLK_PIN) */

#if(SCB_1_SS0_PIN)
    #include "SCB_1_spi_ss0_uart_rts.h"
#endif /* (SCB_1_SS1_PIN) */
...
***************************************/
    ...
    #define SCB_1_MOSI_SCL_RX_WAKE_HSIOM_REG  \
                                                (*(reg32 *) SCB_1_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM)
    #define SCB_1_MOSI_SCL_RX_WAKE_HSIOM_PTR  \
                                                ( (reg32 *) SCB_1_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM)
    #define SCB_1_MOSI_SCL_RX_WAKE_HSIOM_MASK \
                                                (SCB_1_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM_MASK)
    #define SCB_1_MOSI_SCL_RX_WAKE_HSIOM_POS  \
                                                (SCB_1_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM_SHIFT)

    #define SCB_1_MOSI_SCL_RX_WAKE_INTCFG_REG    (*(reg32 *) \
                                                              SCB_1_spi_mosi_i2c_sda_uart_rx_wake__0__INTCFG)
    #define SCB_1_MOSI_SCL_RX_WAKE_INTCFG_PTR    ( (reg32 *) \
                                                              SCB_1_spi_mosi_i2c_sda_uart_rx_wake__0__INTCFG)

    #define SCB_1_INTCFG_TYPE_MASK                  (0x03u)
    #define SCB_1_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS  (SCB_1_spi_mosi_i2c_sda_uart_rx_wake__SHIFT)
...
#if(SCB_1_MOSI_SCL_RX_PIN)
    #define SCB_1_MOSI_SCL_RX_HSIOM_REG      (*(reg32 *) SCB_1_spi_mosi_i2c_sda_uart_rx__0__HSIOM)
    #define SCB_1_MOSI_SCL_RX_HSIOM_PTR      ( (reg32 *) SCB_1_spi_mosi_i2c_sda_uart_rx__0__HSIOM)
    #define SCB_1_MOSI_SCL_RX_HSIOM_MASK     (SCB_1_spi_mosi_i2c_sda_uart_rx__0__HSIOM_MASK)
    #define SCB_1_MOSI_SCL_RX_HSIOM_POS      (SCB_1_spi_mosi_i2c_sda_uart_rx__0__HSIOM_SHIFT)
#endif /* (SCB_1_MOSI_SCL_RX_PIN) */

#if(SCB_1_MISO_SDA_TX_PIN)
    #define SCB_1_MISO_SDA_TX_HSIOM_REG      (*(reg32 *) SCB_1_spi_miso_i2c_scl_uart_tx__0__HSIOM)
    #define SCB_1_MISO_SDA_TX_HSIOM_PTR      ( (reg32 *) SCB_1_spi_miso_i2c_scl_uart_tx__0__HSIOM)
    #define SCB_1_MISO_SDA_TX_HSIOM_MASK     (SCB_1_spi_miso_i2c_scl_uart_tx__0__HSIOM_MASK)
    #define SCB_1_MISO_SDA_TX_HSIOM_POS      (SCB_1_spi_miso_i2c_scl_uart_tx__0__HSIOM_SHIFT)
#endif /* (SCB_1_MISO_SDA_TX_PIN_PIN) */

#if(SCB_1_SCLK_PIN)
    #define SCB_1_SCLK_HSIOM_REG     (*(reg32 *) SCB_1_spi_sclk_uart_cts__0__HSIOM)
    #define SCB_1_SCLK_HSIOM_PTR     ( (reg32 *) SCB_1_spi_sclk_uart_cts__0__HSIOM)
    #define SCB_1_SCLK_HSIOM_MASK    (SCB_1_spi_sclk_uart_cts__0__HSIOM_MASK)
    #define SCB_1_SCLK_HSIOM_POS     (SCB_1_spi_sclk_uart_cts__0__HSIOM_SHIFT)
#endif /* (SCB_1_SCLK_PIN) */

#if(SCB_1_SS0_PIN)
    #define SCB_1_SS0_HSIOM_REG      (*(reg32 *) SCB_1_spi_ss0_uart_rts__0__HSIOM)
    #define SCB_1_SS0_HSIOM_PTR      ( (reg32 *) SCB_1_spi_ss0_uart_rts__0__HSIOM)
    #define SCB_1_SS0_HSIOM_MASK     (SCB_1_spi_ss0_uart_rts__0__HSIOM_MASK)
    #define SCB_1_SS0_HSIOM_POS      (SCB_1_spi_ss0_uart_rts__0__HSIOM_SHIFT)
#endif /* (SCB_1_SS1_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define SCB_1_SET_I2C_SCL_DR(val) \
                            SCB_1_spi_mosi_i2c_sda_uart_rx_Write(val)
    ...
    #define SCB_1_WAIT_SCL_SET_HIGH  (0u == SCB_1_spi_mosi_i2c_sda_uart_rx_Read())
...
/* Unconfigured SCB: sda signal */
    ...
    #define SCB_1_WAIT_SDA_SET_HIGH  (0u == SCB_1_spi_miso_i2c_scl_uart_tx_Read())
