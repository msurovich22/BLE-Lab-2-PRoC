// ======================================================================
// BLE Lab 2-PRoC.v generated from TopDesign.cysch
// 09/29/2016 at 00:32
...
module SCB_P4_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("fb21df50-96b1-48f5-ae29-e79b1a3df784/81fcee8a-3b8b-4be1-9a5f-a5e2e619a938"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("62500000"),
		  .is_direct(0),
...
`ifdef WARP
`define CY_BLK_DIR "$CYPRESS_DIR\..\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bI2S_v2_60"
`include "$CYPRESS_DIR\..\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bI2S_v2_60\bI2S_v2_60.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bI2S_v2_60"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bI2S_v2_60\bI2S_v2_60.v"
`endif

// I2S_v2_60(ClipPresent=false, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, CommonClipThresholds=false, DataBits=16, Direction=1, EnableClipDetect=false, EnableRxByteSwap=false, EnableTxByteSwap=false, InterruptSource=0, NegThresholds=-1, NumRxChannels=2, NumRxLines=1, NumTxChannels=2, NumTxLines=1, PosThresholds=0u, RxDataInterleaved=true, RxDataInterleaving=1, RxDMA_present=1, RxDmaPresent=true, RxInterruptSource=0, RxStsReg0Present=true, RxStsReg1Present=false, RxStsReg2Present=false, StaticBitResolution=true, TermMode_clip=0, TermMode_clock=0, TermMode_rx_dma0=0, TermMode_rx_dma1=0, TermMode_rx_interrupt=0, TermMode_sck=0, TermMode_sdi=0, TermMode_sdo=0, TermMode_tx_dma0=0, TermMode_tx_dma1=0, TermMode_tx_interrupt=0, TermMode_ws=0, TermVisibility_clip=false, TermVisibility_clock=true, TermVisibility_rx_dma0=true, TermVisibility_rx_dma1=false, TermVisibility_rx_interrupt=true, TermVisibility_sck=true, TermVisibility_sdi=true, TermVisibility_sdo=false, TermVisibility_tx_dma0=false, TermVisibility_tx_dma1=false, TermVisibility_tx_interrupt=false, TermVisibility_ws=true, TxDataInterleaved=true, TxDataInterleaving=1, TxDMA_present=1, TxDmaPresent=false, TxInterruptSource=0, TxStsReg0Present=false, TxStsReg1Present=false, TxStsReg2Present=false, WordSelect=64, CY_COMPONENT_NAME=I2S_v2_60, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=I2S_1, CY_INSTANCE_SHORT_NAME=I2S_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=60, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP3, INSTANCE_NAME=I2S_1, )
module I2S_v2_60_2 (
    clock,
    sdi,
    sck,
...
module top ;
    ...
    I2S_v2_60_2 I2S_1 (
        ...
        .ws(Net_2350),
        .sdo(Net_3187[0:0]),
        .rx_dma0(Net_3188[0:0]),
        .rx_dma1(Net_3189[0:0]),
        .tx_dma0(Net_3190[0:0]),
        .tx_dma1(Net_3191[0:0]),
        .rx_interrupt(Net_3192),
        .tx_interrupt(Net_3193),
        .clip(Net_3194[0:0]));
