...
***************************************/
    ...
    volatile uint8 SCB_1_rxBufferInternal[SCB_1_RX_BUFFER_SIZE];
    ...
    uint32 SCB_1_SpiUartReadRxData(void)
    {
        ...
        #if(SCB_1_CHECK_RX_SW_BUFFER)
        {
            if(SCB_1_rxBufferHead != SCB_1_rxBufferTail)
            {
                ...
                if(SCB_1_RX_BUFFER_SIZE == locTail)
                {
                    locTail = 0u;
                }
        ...
        #else
        {
            rxData = SCB_1_RX_FIFO_RD_REG; /* Read data from RX FIFO */
        }
        #endif
    ...
    *******************************************************************************/
    uint32 SCB_1_SpiUartGetRxBufferSize(void)
    {
        ...
        #if(SCB_1_CHECK_RX_SW_BUFFER)
        {
            ...
            {
                size = (locHead + (SCB_1_RX_BUFFER_SIZE - SCB_1_rxBufferTail));
            }
        }
        #else
        {
    ...
    void SCB_1_SpiUartWriteTxData(uint32 txData)
    {
        ...
        #if(SCB_1_CHECK_TX_SW_BUFFER)
        {
            ...
            else
            {
                ...
                intSourceMask  = SCB_1_INTR_TX_NOT_FULL;
                intSourceMask |= SCB_1_GetTxInterruptMode();
                SCB_1_SpiUartEnableIntTx(intSourceMask);
            }
        }
        #else
        {
    ...
    *******************************************************************************/
    void SCB_1_SpiUartClearTxBuffer(void)
    {
        ...
        #if(SCB_1_CHECK_TX_SW_BUFFER)
        {
            intSourceMask = SCB_1_SpiUartDisableIntTx();
            ...
            intSourceMask &= (uint32) ~SCB_1_INTR_TX_NOT_FULL;
